...
目录结构：
POS_001/
  - standing.png / walking.png / running.png ...

命名：POS_001_拔剑 / POS_002_回眸
要求：符合人体结构/重心/力学/身份/服装限制/道具使用方式（§11）。
...
本目录资产属 **POS_** 段，**必须先在 `../00_PROJECT/ID-REGISTRY.md` 登记**：

| 项 | 值 |
|---|---|
| 命名格式 | POS_<3位>_<动作名>（如 POS_001_拔剑） |
| 谁分配 | 02 服化道 |
