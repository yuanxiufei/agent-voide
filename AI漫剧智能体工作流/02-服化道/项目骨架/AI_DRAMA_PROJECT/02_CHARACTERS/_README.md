...
目录结构：
CHARACTER_001/
  - ASSET_CARD.yaml      ← 从 ../../模板/ASSET_CARD.yaml 复制
  - turnaround.png       三视图
  - ref/                 参考图
  - expressions/         表情集
  - poses/               动作集

命名：CHR_001 / CHR_001_State_A / CHR_001_State_B
状态派生不覆盖原卡，新建状态卡（见规则 §29）。
...
本目录资产属 **CHR_** 段，**必须先在 `../00_PROJECT/ID-REGISTRY.md` 登记**：

| 项 | 值 |
|---|---|
| 命名格式 | CHR_<3位>（如 CHR_001） |
| 谁分配 | 01 剧本文本 |
